...
<div class="container">
    <div class="row">
        ...
        <form id="filter_form" class="form-inline">
            ...
            <div class="col-md-4 filter">
                <form class="form-inline">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="text" id="from_date" name="from_date" class="form-control datepicker" value="<?php echo date("d-m-Y", strtotime($graph_date)); ?>">
                        <input type="text" id="to_date" name="to_date" class="form-control datepicker" value="<?php echo date("d-m-Y", strtotime($graph_date)); ?>">
                    </div>
                    ...
                    <div class="form-group col-md-12" style="margin-top: 10px;">
                        ...
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <select class="form-control" style="width: 200px;" disabled name="select_id_no" id="select_id_no">
                            <option></option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-12" style="margin-top: 10px;">
                        <label class="col-md-6"><input type="radio" name="order" id="order" checked>&nbsp;&nbsp;Positive the order</label>
                        <label class="col-md-6"><input type="radio" name="order" id="order">&nbsp;&nbsp;Reverse order</label>
                    </div>
                </form>
            ...
            <div class="col-md-12" style="padding: 20px;">
                <button class="btn btn-primary pull-right" style="margin-left: 20px;" id="retrieval">Retrieval</button>
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $query = "SELECT * FROM {$tblCastData} WHERE process_id = {$default_process}  AND created_at <= '{$end_time}' ORDER BY created_at ASC ";
            $result = $db->query($query);
            $data = array();
            while($row = mysqli_fetch_object($result)) {
                array_push($data, $row);
            ...
            <table class="table table-bordered stripe row-border order-column" id="data_table"   style="width:100%">
                <thead>
                <?php
                echo "<tr>";
